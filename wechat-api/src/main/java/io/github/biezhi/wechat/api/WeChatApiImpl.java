...
public class WeChatApiImpl implements WeChatApi {
  ...
  public Account getAccountByName(String name) {
    for (Account account : accountMap.values()) {
      ...
      if (name.equals(account.getRemarkName()) || account.getRemarkName().contains(name)) {
        return account;
      }
      if (name.equals(account.getNickName()) || account.getNickName().contains(name)) {
        return account;
      }
    }
    return null;
